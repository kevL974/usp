...
class VirtualWallet:
        ...
        for transaction in self._transactions:
            if transaction[0] == 'buy':
                print(
                    ...
                    f'pour {transaction[1]} € (taux : {transaction[5]}) - total funds restant : {transaction[7]}')
            else:
                print(
    ...
    def buy(self, value: float, coin_rate: float, date: str, time: str, num_op: int) -> None:
        ...
        self._transactions.append(('buy', value, self._coins, date, time, coin_rate, num_op, self.get_total_funds()))
    ...
    def sell(self, coins: float, coin_rate: float, date: str, time: str, num_op: int) -> None:
        ...
        self._transactions.append(('sell', coins * coin_rate, coins, date, time, coin_rate, num_op, self.get_total_funds()))